<script lang="ts">
	import { SvelteFlow, Controls, Background, BackgroundVariant, MiniMap, Panel } from '@xyflow/svelte';
	import type { Edge as XYEdge, Node as XYNode, NodeTypes } from '@xyflow/svelte';
	...
	const xyFlowNodes = flowNodes as unknown as Writable<XYNode[]>;
	const xyFlowEdges = flowEdges as unknown as Writable<XYEdge[]>;
