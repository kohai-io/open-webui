...
USER_PERMISSIONS_WORKSPACE_FLOWS_ACCESS = (
    os.environ.get('USER_PERMISSIONS_WORKSPACE_FLOWS_ACCESS', 'False').lower() == 'true'
)
...
USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_SHARING = (
    os.environ.get('USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_SHARING', 'False').lower() == 'true'
)

USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_PUBLIC_SHARING = (
    os.environ.get('USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_PUBLIC_SHARING', 'False').lower() == 'true'
)
...
DEFAULT_USER_PERMISSIONS = {
    'workspace': {
        ...
        'flows': USER_PERMISSIONS_WORKSPACE_FLOWS_ACCESS,
    ...
    'sharing': {
        ...
        'flows': USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_SHARING,
        'public_flows': USER_PERMISSIONS_WORKSPACE_FLOWS_ALLOW_PUBLIC_SHARING,
